...
void AnalyzeHGCOctTB::EventLoop(const char *data, const char *energy) {
  ...
  sprintf(path_to_save, "Results_new_chi2_9bins_ssl_lt_16_varCorPi0_fracRawE/");
 ...
 float ee_rescaling = 1.035;
  ...
  file_ecal_ene_frac.open("Results_new_chi2_9bins_ssl_lt_16_varCorPi0_fracRawE/ecal_hcal_Eneupto13X0_true_pred_SS.txt",ios::out);  
  ...
  sprintf(name1,"Results_new_chi2_9bins_ssl_lt_16_varCorPi0_fracRawE/fitted_parameters_9bins_ssl_lt_16_varCorPi0_fracRawE.txt");
  std::fstream params;
...
//  f_w3_bin10_ss->FixParameter(3, param_vector[179]); 
  ...
  ////////////////////////////////////////////////////    
   	   ...
   	   for (int ecal_bins=0; ecal_bins<9; ecal_bins++)
   	   { 
   	   sprintf(name,"Results_new_chi2_9bins_ssl_lt_16_varCorPi0_fracRawE/chi2_opt_ssInEE_ecal_ene_fracFact_%f_to_%f_flatEn.txt",var_pi0_frac_bins[ecal_bins],var_pi0_frac_bins[ecal_bins+1]);
